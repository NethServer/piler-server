...
# Keys the shipped template is expected to carry, checked for an upstream
# rename. Not every key conf_set writes belongs here: mysqlport is absent
# from the dist on purpose, piler defaulting it to 0.
